...
CREATE TABLE "Configurator" (
    ...
    "stringCollectionIds" TEXT NOT NULL DEFAULT '[]',
    "stringProductIds" TEXT NOT NULL DEFAULT '[]',
    "excludedProductIds" TEXT NOT NULL DEFAULT '[]',
    "allowOutOfStock" BOOLEAN NOT NULL DEFAULT false,
    "allowOutOfStockRacquets" BOOLEAN NOT NULL DEFAULT false,
    "allowOutOfStockStrings" BOOLEAN NOT NULL DEFAULT false,
    "inventoryPolicyBackup" TEXT NOT NULL DEFAULT '{}',
    "hideOutOfStockStrings" BOOLEAN NOT NULL DEFAULT false,
    "laborVariantId" TEXT,
    "laborPrice" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "basePrice" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "currency" TEXT NOT NULL DEFAULT 'USD',
    "enrichedSnapshot" TEXT,
