...
export function SummaryStep() {
  ...
  return (
    <div className="space-y-6">
      <div className="proto-glass rounded-2xl p-5 space-y-3">
      ...
      <div className="proto-glass rounded-2xl p-5 space-y-2">
        ...
        <div
          className="flex justify-between text-lg font-bold pt-3 border-t border-white/10"
          style={{ color: accent }}
        >
          <span>Total</span>
